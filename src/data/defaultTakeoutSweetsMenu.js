...
export const DEFAULT_TAKEOUT_SWEETS_SECTIONS = [
  {
    ...
    titleStyle: '',
    items: [
      { id: 'ts-fr-itigo', name: 'いちご', price: 630, rank: 1, color: '#F48FB1', image: 'furusan-itigo.png' },
      { id: 'ts-fr-furu-tumix', name: 'フルーツミックス', price: 680, rank: 2, color: '#81D4FA', image: 'furusan-furu-tumix.png' },
      { id: 'ts-fr-golden-pine', name: 'ゴールデンパイン', price: 620, rank: 3, color: '#FFB74D', image: 'furusan-go-rudennpainn.png' },
      { id: 'ts-fr-itigokiui', name: 'いちごキウイ', price: 580, image: 'furusan-itigokiui.png' },
      { id: 'ts-fr-itigopain', name: 'いちごパイン', price: 580, image: 'furusan-itigopain.png' },
      { id: 'ts-fr-ichigobanana', name: 'いちごバナナ', price: 600, image: 'furusan-tigobanana.png' },
      { id: 'ts-fr-chocobanana', name: 'バナナチョコ', price: 600, image: 'furusan-tyokobanana.png' },
      { id: 'ts-fr-orange', name: 'オレンジ', price: 600, image: 'furusan-orange.jpg' },
      { id: 'ts-fr-kiui-mix', name: 'キウイミックス', price: 580, image: 'furusan-kiui-mix.jpg' },
    ],
  },
  {
    id: 'ts-sec-kukki',
