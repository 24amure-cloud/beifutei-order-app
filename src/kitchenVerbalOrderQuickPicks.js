...
export const KITCHEN_VERBAL_FOOD_PICKS = [
  { itemId: 'staff-abu-normal-m', itemName: '米風亭 油そば（並）', price: 1180, kind: 'food' },
  { itemId: 'staff-abu-spicy-m', itemName: '辛々担々 油そば（並）', price: 1380, kind: 'food' },
  { itemId: 'staff-abu-cheese-m', itemName: 'チーズ 油そば（並）', price: 1330, kind: 'food' },
